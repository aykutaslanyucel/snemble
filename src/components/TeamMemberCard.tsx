                  ...
                  <div className="grid grid-cols-5 gap-2">
                    {["bg-purple-100", "bg-blue-100", "bg-green-100", "bg-pink-100", "bg-yellow-100"].map((color) => (
                      <button
                        ...
                        onClick={() => onUpdate(member.id, "customization", { ...premiumCustomization, color })}
                      />
                    ))}
                  </div>
                </div>
                  ...
                  <div className="flex gap-2">
                    {["🎩", "👑", "🎓", "⛑️", "🪖"].map((hat) => (
                      <button
                        ...
                        onClick={() => onUpdate(member.id, "customization", { ...premiumCustomization, hat })}
                      >
                        {hat}
                      </button>
                    ))}
                  ...
                  <div className="flex gap-2">
                    {["😊", "🚀", "💪", "✨", "🌟"].map((emoji) => (
                      <button
                        ...
                        onClick={() => onUpdate(member.id, "customization", { ...premiumCustomization, emoji })}
                      >
                        {emoji}
                      </button>
                    ))}
          ...
          <div className="flex items-center justify-between mt-4">
            <Badge variant="outline" className="bg-white/50">
              ...
              >
                ...
                {currentStatus.label}
                {premiumCustomization.hat && (
                  <span className="ml-1">{premiumCustomization.hat}</span>
                )}
              </motion.div>
            </Badge>
